...
struct FAircraftState
{
  GENERATED_BODY()
	...
	FString GetDebugMessage()
	{
		...
		DebugMessage += FString::Printf(TEXT("        AltitudeASL %.2f (ft)     AltitudeAGL %.2f (ft)     AltitudeRateFtps %.2f (ft/s)     StallWarning %d"), AltitudeASLFt, AltitudeAGLFt, AltitudeRateFtps, (int)StallWarning) + LINE_TERMINATOR;
